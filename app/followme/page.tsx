...
function Page(){
    return(
        <section className="baseContainerSection extraContainerSection flex-col bg-gradient-radial from-pink-700 via-pink-950 to-black text-center text-2xl font-black lg:flex-row">
